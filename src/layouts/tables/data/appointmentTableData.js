...
const AppointmentTable = ()=> {
 const columns  =  [
    { Header: "name", accessor: "patient.full_name", width: "30%", align: "left" },
    { Header: "country", accessor: "doctor.full_name", align: "left" },
    { Header: "Price", accessor: "price", align: "center" },
    { Header: "expiredate", accessor: "date", align: "center" },
...
<Card>
  ...
  <MDBox pt={3}>
    <DataTable
      table={{ columns: columns, rows: data.appointments }}
      isSorted={true}
      entriesPerPage={true}
